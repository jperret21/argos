...
from argos.ui.analysis_window import read_fits_2d, read_fits_meta  # shared FITS read helpers
...
class PhotometrySetupWindow(QWidget):
    ...
    def _on_run(self) -> None:
        ...
        from argos.core.photometry.lightcurve import LightCurve, LcPoint
